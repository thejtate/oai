...
$watch_video = isset($watch_video) ? $watch_video : '';
?>
            ...
            <section class="section section-media item item-style-a">
              ...
              <?php if ($watch_video): ?>
                <a class="btn-play" data-toggle="modal"
                   ...
                   href="#video"><?php print t('WATCH VIDEO'); ?></a>
              <?php endif; ?>
            </section>
          <?php endif; ?>
            ...
            <div class="text">
              <div class="b-search container">
                ...
                <?php if ($page['sidebar_left']): ?>
                  <div
                    class="<?php print (isset($left_sidebar_class)) ? implode(' ', $left_sidebar_class) : ''; ?>">
                    <?php print render($page['sidebar_left']); ?>
                  </div>
                <?php endif; ?>

                <div
                  class="<?php print (isset($content_class) && is_array($content_class)) ? implode(' ', $content_class) : ''; ?>">
                ...
                <?php if ($page['sidebar_right']): ?>
                  <div
                    class="sidebar <?php print (isset($sidebar_class) && is_array($sidebar_class)) ? implode(' ', $sidebar_class) : ''; ?>">
