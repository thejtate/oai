...
<div class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  ...
  <div class="content"<?php print $content_attributes; ?>>
    ...
    <div class="text-block-type-a <?php print isset($color_class) ? $color_class : ''; ?>">
      ...
      <?php print render($content['field_donate_block_desc']); ?>
      <div class="subdesc">
        <strong><?php print render($content['field_donate_block_name']); ?></strong>,
        <?php print render($content['field_donate_block_position']); ?>
      </div>
      <?php if (isset($content['field_donate_block_email'])): ?>
        <div class="subtext">
          <span class="font-color-k"><?php print t('Email'); ?></span>
      ...
      <?php if (isset($content['field_donate_block_phone'])): ?>
        <div class="subtext">
          <span class="font-color-k"><?php print t('Phone'); ?></span>
